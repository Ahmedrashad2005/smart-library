...
const copy = {
  ...
  en: {
    ...
    filters: 'Campus Library filters',
  },
} as const;
...
export function CampusPage({ locale, go }: Props): JSX.Element {
  ...
  const libraryName = library ? (locale === 'ar' ? library.nameAr : library.nameEn) : labels.title;
